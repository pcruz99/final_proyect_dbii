      ...
      <section className="bg-white  dark:bg-gray-900">
        <div className="mx-auto py-8 px-8 max-w-screen-xl">
          ...
          <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
            Reservas de tu HotelFavorito
          </p>
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg ">
            <div className="pb-4 bg-white dark:bg-gray-900">
              <label htmlFor="id_buscar_rese" className="sr-only">Search</label>
                ...
                <tr>
                  <th scope="col" className="p-4">
                    <div className="flex items-center">
                      <input id="id_check_re" type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                      <label htmlFor="id_check_re" className="sr-only">checkbox</label>
                    </div>
                  </th>
