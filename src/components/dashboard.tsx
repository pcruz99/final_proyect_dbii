...
import Huesped from 'src/components/huesped'
                            ...
                            <div className="flex h-16 items-center justify-between">
                                <div className="flex items-center">
                                    <div className="flex-shrink-0">
                                        <img className="h-8 w-8" src="https://media.istockphoto.com/id/1324431789/es/vector/plantilla-de-dise%C3%B1o-de-logotipo-lineal-vintage-floral-redondo-para-boutique-o-hotel-o-sal%C3%B3n.jpg?b=1&s=170667a&w=0&k=20&c=NFYDz814HW0GWyoVHDu0SBG8zPqG5I8tHsdQNamYBUE=" alt="Your Company" />
                                    </div>
                                    <div className="hidden md:block">
                                        <div className="ml-10 flex items-baseline space-x-4">
                                            ...
                                            <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Cliente</a>

                                            <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Reservar</a>

                                            <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Habitacion</a>

                                            <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Garantia</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="hidden md:block">
                                        ...
                                        <div className="relative ml-3">
                                            <div>
                                                <button type="button" className="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                                    ...
                                                    <img className="h-8 w-8 rounded-full" src="https://png.pngtree.com/png-vector/20220704/ourlarge/pngtree-hotel-bell-icon-reception-abstract-png-image_5613257.png" alt="" />
                                                </button>
                                            </div>
                        ...
                        <div className="md:hidden" id="mobile-menu">
                            ...
                            <div className="border-t border-gray-700 pt-4 pb-3">
                                <div className="flex items-center px-5">
                                    <div className="flex-shrink-0">
                                        <img className="h-10 w-10 rounded-full" src="https://png.pngtree.com/png-vector/20220704/ourlarge/pngtree-hotel-bell-icon-reception-abstract-png-image_5613257.png" alt="" />
                                    </div>
                                    <div className="ml-3">
                                        <div className="text-base font-medium leading-none text-white">admin</div>
                                        <div className="text-sm font-medium leading-none text-gray-400">admin@example.com</div>
                                    </div>
